package com.MyApps.myprescription.ui.theme

import androidx.compose.ui.graphics.Color

val PrimaryLight = Color(0xFF006A6A)
val OnPrimaryLight = Color.White
val PrimaryContainerLight = Color(0xFF70F7F6)
...
val PrimaryDark = Color(0xFF4DDCDC)
val OnPrimaryDark = Color(0xFF003737)
val PrimaryContainerDark = Color(0xFF005050)
val OnPrimaryContainerDark = Color(0xFF70F7F6)
val SecondaryDark = Color(0xFFB1CCCB)
val OnSecondaryDark = Color(0xFF1B3535)
